...
class AppColors {
  ...
  static final Color twitterColor = Color(0XFF8CD3F1);
  static final Color twitterButtonColor = Color(0XFF1BA7E2);
  static final Color googleColor = Color(0XFFF2A698);
  static final Color googleButtonColor = Color(0XFFE34F31);
}
